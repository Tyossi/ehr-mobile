...
const getHealthConditions = async (patientID) => {
...
const HealthCondition = () => {
  ...
  //     queryKey: ["healthConditions", patientID],
  //     queryFn: () => getHealthConditions(patientID),
  //   });
  ...
  return (
    <div className="health__condition-container">
      <PageNav title="Health Condition" />
      <div
      ...
      <div className="health__conditions">
        <div
          ...
          onClick={() => navigate(`/panel/health-condition/${1}`)}
        >
        ...
        <div className="health__condition">
          <p className="health__condition-label">Health Condition</p>
          <p className="health__condition-text">Maleria & Typhoid</p>
          <div className="health__condition-date">
            <CalendarIcon />
